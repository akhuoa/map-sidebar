...
export default {
  ...
  data: function () {
    return {
      ...
      envVars: {
        API_LOCATION: import.meta.env.VITE_API_LOCATION,
        ALGOLIA_KEY: import.meta.env.VITE_ALGOLIA_KEY,
        ALGOLIA_ID: import.meta.env.VITE_ALGOLIA_ID,
        ALGOLIA_INDEX: import.meta.env.VITE_ALGOLIA_INDEX,
        PENNSIEVE_API_LOCATION: import.meta.env.VITE_PENNSIEVE_API_LOCATION,
